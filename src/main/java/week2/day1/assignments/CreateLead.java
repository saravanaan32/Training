...
public class CreateLead {
	...
	public static void main(String[] args) {
		...
		//Even you can pass the values to listbox by sendkeys also
		//driver.findElementByName("dataSourceId").sendKeys("conference");
		...
		//WebElement oneElement = industryElementList.get(1);
		//oneElement.click();
		...
		for (int i = 1; i < ownershipElements.size(); i++) {
			System.out.println("The Ownership list are:- " +ownershipElements.get(i).getText());
		}
		...
		/// ***************Web Element List - For Each Iterator*************************//
		...
		/********************* Email Address Implemented for Duplicate Lead scenario ************************/
